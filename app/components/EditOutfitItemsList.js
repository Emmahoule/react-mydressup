...
import EditOutfitInfos from './EditOutfitInfos';
...
class EditOutfitItemsList extends Component {
  constructor(props) {
      super(props);
      this.state = {
        list: {},
  ...
  render() {
    ...
    const {fetchItems, dataItems, dataCategories, dataCategoriesUser, fetchCategories, fetchCategoriesByUser, onClickItem, listItems, hideSourceOnDrag, onRemoveAllItems, onUpdateItem, onDeleteItem, onClickCreateOutfitImage, onClickCreateOutfitInfos,fetchOutfit,dataOutfit} = this.props
...
export default DragDropContext(HTML5Backend)(EditOutfitItemsList)
